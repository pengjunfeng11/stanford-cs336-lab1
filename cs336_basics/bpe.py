...
if os.path.exists(cache_path):
    ...
    with open('/mnt/d/WorkSpace/cs336/lab1/assignment1-basics/cs336_basics/data/TinyStoriesV2-GPT4-train.txt', 'r', encoding='utf-8') as f:
...
# 将byte_dict保存到本地
# 保存byte_dict到文件
with open('/mnt/d/WorkSpace/cs336/lab1/assignment1-basics/cs336_basics/byte_dict.pkl', 'wb') as f:
...
def iter_byte_dict(iter_nums:int):
    ...
    for _ in tqdm(range(iter_nums), desc="迭代次数"):
        temp_dict = {}
        for byte_tuple, value in tqdm(byte_dict.items(), desc="处理byte_tuple", leave=False):
        ...
        new_byte_dict = {}
        for byte_tuple, value in tqdm(byte_dict.items(), desc="更新byte_dict", leave=False):
            byte_list = list(byte_tuple)
            i = 0
            _merged_temp_list = []
